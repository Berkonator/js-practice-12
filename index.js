...
function convertMapToObject(map) {
  const me = map.entries()
  return Object.fromEntries(me)
...
function sortByValues(dictionary) {
  ...
  const sorted = arr.sort((function(a, b) {return b[1] - a[1]}))
  let a = new Map();
  return a.set(arr)
...
function convertSetToDictionary(set) {
  const dict = new Map();
  for(let elem of set){
    dict.set(elem, elem.charCodeAt(0))
  }
  return dict
